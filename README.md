...
local package layering is disabled by default.  you can disable this, though the intended workflow is distrobox + flatpaks.  the ISO is the main installation path, rebase instructions are provided for convenience and reproducability
